...
export default function Footer() {
  ...
  return (
    <section className={`flex flex-col pt-6 pb-2 px-4 lg:px-16 items-center justify-between bgFooter`}>
      ...
      {/* Owner */}
      <div className='flex flex-col items-center gap-2 md:flex-row md:justify-around md:w-full' >
        <div className={`max-w-screen-xl flex justify-between items-center`}>
          <Image
            className={`w-48 h-auto sm:mb-4 md:w-56`}
        ...
        <div className={`max-w-screen-xl flex justify-between items-center gap-2 md:gap-4 mb-4`}>
          <Link
          ...
          ><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className='w-7 h-auto fill-gray-100 hover:origin-center  hover:scale-x-110 ease-in-out duration-200'> <path d="M11.999 7.377a4.623 4.623 0 1 0 0 9.248 4.623 4.623 0 0 0 0-9.248zm0 7.627a3.004 3.004 0 1 1 0-6.008 3.004 3.004 0 0 1 0 6.008z" />              <circle cx="16.806" cy="7.207" r="1.078" />
